...
title <- tags$div(
  tag.map.title, HTML("<h2>NYC's dangerous 25mph streets</h2><br><p>25mph streets with the most collisions per mile caused by unsafe speed<br><span>Select a street</span> to view the number of collisions since 2019</p>")
)  
